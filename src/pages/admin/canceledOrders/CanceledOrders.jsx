...
const CanceledOrders = () => {
    ...
    useEffect(() => {
        setLoading(true);
        fetch("https://furniro-server-bay.vercel.app/cancelledOrders")
            .then((res) => res.json())
            .then((data) => {
                setOrders(data);
                setLoading(false);
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                <div>
                    <h2 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
                        <HiOutlineBan className="text-red-600" />
                        Cancelled Orders
                    </h2>
                    <p className="text-gray-500 text-sm mt-1">
                        List of all orders that have been cancelled
                    </p>
                </div>
            ...
            {orders.length === 0 ? (
                <div className="flex flex-col justify-center items-center h-[60vh] bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-gray-500 mt-2">
                        Great! You don't have any cancelled orders currently.
                    </p>
                </div>
            ) : (
                            ...
                            >
                                ...
                                <div className="bg-gray-50 px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4 border-b border-gray-100">
                                    <div className="flex items-center gap-4">
                                        <div className="bg-red-100 text-red-700 px-3 py-1 rounded text-sm font-bold">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide bg-red-100 text-red-700 flex items-center gap-1">
                            ...
                            <div className="flex flex-col h-full">
                                <div className="bg-white border border-gray-200 rounded-xl p-5 flex-1 h-full">
                                    ...
                                    <div className="mt-auto pt-6 border-t border-dashed border-gray-300">
                                        ...
                                        <div className="flex justify-between items-center mt-4 text-lg font-bold text-red-600 bg-red-50 p-3 rounded-lg">
